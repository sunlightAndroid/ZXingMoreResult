...
//            if (handler != null) {
//                Message message = Message.obtain(handler, R.id.decode_succeeded, list);
//                Log.d("Debug", "decode() returned: " + "加入了。。。。---"+list.size()+"--"+hints.size());
...
//        Result rawResult = null;
        ...
        if (source != null) {
            ...
            try {
//                rawResult = multiFormatReader.decodeWithState(bitmap);
//                rawResult = qrCodeMultiReader.decode(bitmap, hints);
...
//                qrCodeReader.reset();
        ...
        //handler:CaptureActivity中的成员变量CaptureActivityHandler
        Handler handler = activity.getHandler();
//        if (rawResult != null) {
//            // Don't log the barcode contents for security.
//            if (handler != null) {
